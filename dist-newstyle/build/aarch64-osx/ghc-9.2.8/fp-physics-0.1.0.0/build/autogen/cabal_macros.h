...
/* package fp-physics-0.1.0.0 */
#ifndef VERSION_fp_physics
#define VERSION_fp_physics "0.1.0.0"
#endif /* VERSION_fp_physics */
#ifndef MIN_VERSION_fp_physics
#define MIN_VERSION_fp_physics(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_fp_physics */
...
#define CURRENT_PACKAGE_KEY "fp-physics-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "fp-physics-0.1.0.0-inplace"
